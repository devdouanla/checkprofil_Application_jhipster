...
export const QuestionDeleteDialog = () => {
  ...
  return (
    <Modal show onHide={handleClose}>
      <ModalHeader data-cy="questionDeleteDialogHeading" closeButton>
        <Translate contentKey="entity.delete.title">Confirm delete operation</Translate>
      </ModalHeader>
      <ModalBody id="checkprofileApp.question.delete.question">
        <Translate contentKey="checkprofileApp.question.delete.question" interpolate={{ id: questionEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-question" data-cy="entityConfirmDeleteButton" variant="danger" onClick={confirmDelete}>
