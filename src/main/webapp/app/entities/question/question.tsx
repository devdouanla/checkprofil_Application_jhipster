  ...
  return (
    <div>
      <h2 id="question-heading" data-cy="QuestionHeading">
        <Translate contentKey="checkprofileApp.question.home.title">Questions</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" variant="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="checkprofileApp.question.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/question/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="checkprofileApp.question.home.createLabel">Create new Question</Translate>
          </Link>
        </div>
      </h2>
        ...
        {questionList?.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="checkprofileApp.question.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th className="hand" onClick={sort('reponseTexte')}>
                  <Translate contentKey="checkprofileApp.question.reponseTexte">Reponse Texte</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('reponseTexte')} />
                </th>
                ...
                <th className="hand" onClick={sort('explication')}>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="checkprofileApp.question.home.notFound">No Questions found</Translate>
            </div>
          )
        )}
      </div>
