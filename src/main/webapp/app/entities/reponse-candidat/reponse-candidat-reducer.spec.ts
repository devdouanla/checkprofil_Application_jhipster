...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REPONSECANDIDAT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REPONSECANDIDAT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REPONSECANDIDAT actions', async () => {
      const arg = { id: 7826 };
    ...
    it('dispatches UPDATE_REPONSECANDIDAT actions', async () => {
      const arg = { id: 7826 };
    ...
    it('dispatches PARTIAL_UPDATE_REPONSECANDIDAT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REPONSECANDIDAT actions', async () => {
      const arg = 42666;
