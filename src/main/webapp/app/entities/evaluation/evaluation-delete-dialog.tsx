...
export const EvaluationDeleteDialog = () => {
  ...
  return (
    <Modal show onHide={handleClose}>
      ...
      <ModalBody id="checkprofileApp.evaluation.delete.question">
        <Translate contentKey="checkprofileApp.evaluation.delete.question" interpolate={{ id: evaluationEntity.id }}>
