...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './expert.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXPERT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EXPERT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EXPERT actions', async () => {
      const arg = { id: 1741 };
    ...
    it('dispatches UPDATE_EXPERT actions', async () => {
      const arg = { id: 1741 };
    ...
    it('dispatches PARTIAL_UPDATE_EXPERT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EXPERT actions', async () => {
      const arg = 42666;
