...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './employe.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EMPLOYE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EMPLOYE actions', async () => {
      const arg = { id: 22213 };
    ...
    it('dispatches UPDATE_EMPLOYE actions', async () => {
      const arg = { id: 22213 };
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EMPLOYE actions', async () => {
      const arg = 42666;
