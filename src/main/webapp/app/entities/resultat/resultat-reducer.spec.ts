...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './resultat.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESULTAT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RESULTAT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RESULTAT actions', async () => {
      const arg = { id: 23651 };
    ...
    it('dispatches UPDATE_RESULTAT actions', async () => {
      const arg = { id: 23651 };
    ...
    it('dispatches PARTIAL_UPDATE_RESULTAT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RESULTAT actions', async () => {
      const arg = 42666;
