...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './poste.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_POSTE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_POSTE actions', async () => {
      const arg = { id: 12668 };
    ...
    it('dispatches UPDATE_POSTE actions', async () => {
      const arg = { id: 12668 };
    ...
    it('dispatches PARTIAL_UPDATE_POSTE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_POSTE actions', async () => {
      const arg = 42666;
