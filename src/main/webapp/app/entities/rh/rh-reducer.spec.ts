...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './rh.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RH_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RH actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RH actions', async () => {
      const arg = { id: 21555 };
    ...
    it('dispatches UPDATE_RH actions', async () => {
      const arg = { id: 21555 };
    ...
    it('dispatches PARTIAL_UPDATE_RH actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RH actions', async () => {
      const arg = 42666;
