...
export const CompetenceDeleteDialog = () => {
  ...
  return (
    <Modal show onHide={handleClose}>
      ...
      <ModalBody id="checkprofileApp.competence.delete.question">
        <Translate contentKey="checkprofileApp.competence.delete.question" interpolate={{ id: competenceEntity.id }}>
