...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPETENCE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMPETENCE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMPETENCE actions', async () => {
      const arg = { id: 29641 };
    ...
    it('dispatches UPDATE_COMPETENCE actions', async () => {
      const arg = { id: 29641 };
    ...
    it('dispatches PARTIAL_UPDATE_COMPETENCE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMPETENCE actions', async () => {
      const arg = 42666;
