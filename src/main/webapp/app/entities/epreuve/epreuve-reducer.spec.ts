...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './epreuve.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EPREUVE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EPREUVE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EPREUVE actions', async () => {
      const arg = { id: 25434 };
    ...
    it('dispatches UPDATE_EPREUVE actions', async () => {
      const arg = { id: 25434 };
    ...
    it('dispatches PARTIAL_UPDATE_EPREUVE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EPREUVE actions', async () => {
      const arg = 42666;
