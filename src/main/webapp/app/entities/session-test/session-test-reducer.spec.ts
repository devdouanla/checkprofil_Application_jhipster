...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SESSIONTEST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SESSIONTEST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SESSIONTEST actions', async () => {
      const arg = { id: 25828 };
    ...
    it('dispatches UPDATE_SESSIONTEST actions', async () => {
      const arg = { id: 25828 };
    ...
    it('dispatches PARTIAL_UPDATE_SESSIONTEST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SESSIONTEST actions', async () => {
      const arg = 42666;
