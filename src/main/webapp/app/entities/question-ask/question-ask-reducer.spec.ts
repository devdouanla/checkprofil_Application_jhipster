...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUESTIONASK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_QUESTIONASK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_QUESTIONASK actions', async () => {
      const arg = { id: 16263 };
    ...
    it('dispatches UPDATE_QUESTIONASK actions', async () => {
      const arg = { id: 16263 };
    ...
    it('dispatches PARTIAL_UPDATE_QUESTIONASK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_QUESTIONASK actions', async () => {
      const arg = 42666;
