...
import reducer, {
  ...
  reset,
  updateEntity,
} from './competence-requise.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPETENCEREQUISE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMPETENCEREQUISE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMPETENCEREQUISE actions', async () => {
      const arg = { id: 30352 };
    ...
    it('dispatches UPDATE_COMPETENCEREQUISE actions', async () => {
      const arg = { id: 30352 };
    ...
    it('dispatches PARTIAL_UPDATE_COMPETENCEREQUISE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMPETENCEREQUISE actions', async () => {
      const arg = 42666;
