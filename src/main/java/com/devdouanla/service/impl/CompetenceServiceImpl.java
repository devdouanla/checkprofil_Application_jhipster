...
/**
 * Service Implementation for managing {@link com.devdouanla.domain.Competence}.
 */
@Service
@Transactional
public class CompetenceServiceImpl implements CompetenceService {
    ...
    public Page<CompetenceDTO> findAllWithEagerRelationships(Pageable pageable) {
        return competenceRepository.findAllWithEagerRelationships(pageable).map(competenceMapper::toDto);
    }
    ...
    public Optional<CompetenceDTO> findOne(Long id) {
        ...
        return competenceRepository.findOneWithEagerRelationships(id).map(competenceMapper::toDto);
    }
