...
class PosteResourceIT {
    ...
    private static final Niveau DEFAULT_NIVEAU = Niveau.JUNIOR;
    private static final Niveau UPDATED_NIVEAU = Niveau.SENIOR;
    ...
    public static Poste createEntity() {
        return new Poste().nom(DEFAULT_NOM).niveau(DEFAULT_NIVEAU);
    }
    ...
    public static Poste createUpdatedEntity() {
        return new Poste().nom(UPDATED_NOM).niveau(UPDATED_NIVEAU);
    }
    ...
    void putExistingPoste() throws Exception {
        ...
        updatedPoste.nom(UPDATED_NOM).niveau(UPDATED_NIVEAU);
    ...
    void partialUpdatePosteWithPatch() throws Exception {
        ...
        partialUpdatedPoste.niveau(UPDATED_NIVEAU);
    ...
    void fullUpdatePosteWithPatch() throws Exception {
        ...
        partialUpdatedPoste.nom(UPDATED_NOM).niveau(UPDATED_NIVEAU);
